                ...
                <div class="container-fluid">
                    <div class="row">
                        <main class="main col">
                            <form method="post">
                            <div class="card">
                                <h3 class="card-header text-center">Registro de Residentes</h3>
                                <div class="card-body text-center">
                                        <?php 
                                        include("../php/controler-residentes.php")
                                        ?>
                                    <div class="row">
                                        ...
                                        <div class="col text-justify">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ingrese el numero de documento" name="doc" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col mb-4 text-justify">
                                            <label for="first"><strong>Email *</strong></label>
                                            <input type="text" class="form-control" placeholder="Ingresar dirección" name="correo" required>
                                        </div>
                                        <div class="col text-justify">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col text-justify">
                                            <label for="last" style="width: 300px;"><strong>Telefono *</strong></label>
                                            <input type="text" class="form-control" placeholder="Ingresar correo" name="telefono" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col mb-4 text-justify">
                                        <label for="selector"> <strong>Bloque Apto *</strong></label>
                                        <select id="selector" class="form-control" name="bloque_apto">
                                            <option selected>Selección.</option>
                                            <?php while($row = mysqli_fetch_array($result_bloque)) {?>
                                            <option> <?php echo $row['bloque'] ?></option>
                                            <?php }?>
                                        </select>
                                        </div>
                                        <div class="col text-justify">
                                        <label for="selector"> <strong>Numero Apto *</strong></label>
                                        <select id="selector" class="form-control" name="numero_apto">
                                            <option selected>Selección.</option>
                                            <?php while($row = mysqli_fetch_array($result_numero)) {?>
                                            <option> <?php echo $row['numeroapartamento'] ?></option>
                                            <?php }?>
                                        </select>
                                        </div>
                                    </div>
                                    ...
                                    <br><br>
                                    <input type="submit" value="Resgistrar" name="btnresidente" class="btn btn-primary">
