                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col text-justify">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ingrese el apellido" name="doc" required>
                                        </div>
                                    ...
                                    <br><br>
                                    <input type="submit" value="Iniciar sesión" name="btnresidente" class="btn btn-primary">
