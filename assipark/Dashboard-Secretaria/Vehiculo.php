                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="text-center text-fluid" method="post">
                            ...
                            if(isset($_SESSION['message-parq'])){?>
                            ...
                            <?php 
                            unset($_SESSION['message-parq']);
                            } ?>
                            
                            <?php 
                            if(isset($_SESSION['message-parq-alert'])){?>
                                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                    Vehiculo registrado anteriormente
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                            ...
                            unset($_SESSION['message-parq']);
                                ...
                                <input type="submit" value="Iniciar sesión" name="btnvehiculo" class="btn btn-warning">
                        </div>
                    </div>
                    </form>      
                    </div>
