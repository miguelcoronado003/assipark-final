...
if(isset($_GET['idusuario'])){
    $id1 = $_GET['idusuario'];
    $query1 = "update usuario set estadousuario = 'Inactivo' where idusuario ='$id1'";
...
if(isset($_GET['idvisitante'])){
    ...
    $query2 = "update visitante set estadovisitante = 'Inactivo' where idvisitante ='$id2'";
...
if(isset($_GET['idresidente'])){
    ...
    $query3 = "update residente set estadoresidente = 'Inactivo' where idresidente ='$id3'";
